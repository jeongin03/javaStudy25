...
public class DmbCellPhoneExam {
	...
	public static void main(String[] args) {
		...
		// 전화에 대한 부모 메소드 활용
		dmbPhone.powerOn(); // 전원 킵니다.
		dmbPhone.bell(); // 전화벨이 울립니다.
		dmbPhone.sendVoice("여보세요");
		dmbPhone.receiveVoice("안녕하세요 숭숭이입니다.");
		dmbPhone.sendVoice("방가방가");
		dmbPhone.receiveVoice("테스트 종료합니다. 잘가시게");
		dmbPhone.hangup(); // 전화 종료
		System.out.println("-----------------------------");
		
		// dmb에 대한 방송ㅇ 자식 메소드 활용
		dmbPhone.turnOnDmb(); // dmb 전원을 킵니다.
