...
public class LottoExam { // 객체
	...
	public static void main(String[] args) { // 주메서드
		...
		Scanner in = new Scanner(System.in) ; // 키보드로 입력받는 객체를 in변수에 연결
		System.out.println("로또 1부터 45까지의 번호 중 6개를 입력해주세요");
		...
		System.out.println("여섯번째 번호 : " + myNum6); // 키보드로 번호 6개를 입력 받아 저장
