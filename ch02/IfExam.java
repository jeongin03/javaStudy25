...
public class IfExam {
	...
	public static void main(String[] args) {
		...
		if (score < 0 || score <= 100) { // 0보다 크거나 100이하면 true
			if (score >= 90) { // score변수에 입력된 값이 90이상이냐?
				System.out.println(name + "님 이 입력하신 점수가 90점 이상니다.");
				System.out.println("점수 : " + score + " : 등급(A) ");
	   	} else if (score >= 80) {
	   		System.out.println(name + "님 이 입력하신 점수가 89~80점 이상니다.");
	   		System.out.println("점수 : " + score + " : 등급 (B) ");
	   	}else if (score >= 70) {
	   		System.out.println(name + "님 이 입력하신 점수가 79~70점 이상니다.");
	   		System.out.println("점수 : " + score + " : 등급 (C) ");
	   	}else if (score >= 60) {
	   		System.out.println(name + "님 이 입력하신 점수가 69~60점 이상니다.");
	   		System.out.println("점수: " + score + " : 등급 (D) ");
	   	}else {
	   		System.out.println(name + "님 이 입력하신 점수가 낮아 등급 F로 결점됨.");
	...
	} // main 메서드 종료 -> input, name, score 가 사라짐
